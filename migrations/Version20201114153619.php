 ...
 */
final class Version20201114153619 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_6E233A4BFCF77503 ON zonelibrehrs (societe_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_6E233A4BFCF77503 ON zonelibrehrs');
